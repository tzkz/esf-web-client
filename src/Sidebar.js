...
const Sidebar = ({ onOverlayClick }) => (
  <div className={css(Container)}>
    <div className={css(drawerContainer)}>
          ...
          <div className={css(buttonsContainer)}>
            <div className={css(Icons)}>
              <svg height='10px' width='18px' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 17.9 10'><defs />
                <path fill='#727272' id='path' d='M779.2 1086.8v-2h2v2zm0 4v-2h2v2zm0 4v-2h2v2zm3.9-10h14v2h-14zm0 6v-2h14v2zm0 4v-2h14v2z' className='cls-1' transform='translate(-779.2 -1084.8)' />
              </svg>
            </div>
            <div className={css(buttons)}>
                Results
      ...
      <div className={css(searchResultContainer, navItemGrow)}>
        <div className={css(buttonsContainer)}>
          <div className={css(Icons)}>
        ...
        <NavLink exact to="/" className={css(navLinkItem)} activeStyle={(active)}>
          <div className={css(buttonsContainer)}>
            <div className={css(Icons)}>
            <svg height='20px' width='20px' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 20 20'><defs />
              <path fill='#727272' id='ic_help_outline_24px' d='M11 18h2v-2h-2zm1-16a10 10 0 1 0 10 10A10 10 0 0 0 12 2zm0 18a8 8 0 1 1 8-8 8.011 8.011 0 0 1-8 8zm0-14a4 4 0 0 0-4 4h2a2 2 0 0 1 4 0c0 2-3 1.75-3 5h2c0-2.25 3-2.5 3-5a4 4 0 0 0-4-4z' className='cls-1' transform='translate(-2 -2)' />
            </svg>
            </div>
            <div className={css(buttons)}>
              Contact Us
